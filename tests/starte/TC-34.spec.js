...
test('test', async ({ page }) => {
  ...
  await page.getByRole('textbox', { name: 'เลขหลุม' }).nth(3).click();
  await page.getByRole('textbox', { name: 'เลขหลุม' }).nth(3).fill('4');
  await page.getByRole('button', { name: 'ยืนยัน' }).nth(3).click();
